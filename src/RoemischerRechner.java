...
public class RoemischerRechner {
...
//	    		+ "____________________________\n\n");
		...
		Zahlformatierung.werteAufbauen();
		String test = Zahlformatierung.formatiertInRoemisch(38999);
		System.out.println(test);
		Zahlformatierung.istGueltigRoemisch(test);
//		Zahlformatierung.ausgabeTest();
//		Menue.schleife();	
